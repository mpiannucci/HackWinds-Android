...
package com.appspot.hackwinds.camera;

/**
 * Service definition for Camera (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link CameraRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class Camera extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.23.0 of the camera library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "camera/v1/";
   ...
   * @since 1.7
   */
  public Camera(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
  ...
  /**
   * Create a request for the method "cameras".
   *
   * This request holds the parameters needed by the camera server.  After setting any optional
  ...
  public class Cameras extends CameraRequest<com.appspot.hackwinds.camera.model.ModelCameraMessagesCameraLocationsMessage> {

    private static final String REST_PATH = "cameras";

    /**
     * Create a request for the method "cameras".
     *
     * This request holds the parameters needed by the the camera server.  After setting any optional
     * parameters, call the {@link Cameras#execute()} method to invoke the remote operation. <p>
     * {@link
    ...
    protected Cameras(java.lang.Boolean premium) {
      super(Camera.this, "GET", REST_PATH, null, com.appspot.hackwinds.camera.model.ModelCameraMessagesCameraLocationsMessage.class);
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link Camera}. */
    @Override
    public Camera build() {
    ...
    /**
     * Set the {@link CameraRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setCameraRequestInitializer(
        CameraRequestInitializer cameraRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(cameraRequestInitializer);
    }
