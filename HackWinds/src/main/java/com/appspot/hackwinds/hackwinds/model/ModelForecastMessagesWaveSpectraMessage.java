...
/**
 * Model definition for ModelForecastMessagesWaveSpectraMessage.
 *
...
public final class ModelForecastMessagesWaveSpectraMessage extends com.google.api.client.json.GenericJson {
   ...
   */
  public ModelForecastMessagesWaveSpectraMessage setAngle(java.util.List<java.lang.Double> angle) {
    this.angle = angle;
    return this;
  }
   ...
   */
  public ModelForecastMessagesWaveSpectraMessage setEnergy(java.util.List<java.lang.Double> energy) {
    this.energy = energy;
    return this;
  }
   ...
   */
  public ModelForecastMessagesWaveSpectraMessage setFrequency(java.util.List<java.lang.Double> frequency) {
   ...
   */
  public ModelForecastMessagesWaveSpectraMessage setSeperationFrequency(java.lang.Double seperationFrequency) {
    this.seperationFrequency = seperationFrequency;
    return this;
  }

  @Override
  public ModelForecastMessagesWaveSpectraMessage set(String fieldName, Object value) {
    return (ModelForecastMessagesWaveSpectraMessage) super.set(fieldName, value);
  }

  @Override
  public ModelForecastMessagesWaveSpectraMessage clone() {
    return (ModelForecastMessagesWaveSpectraMessage) super.clone();
  }
