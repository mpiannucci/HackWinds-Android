...
/**
 * Model definition for ModelForecastMessagesSwellMessage.
 *
...
public final class ModelForecastMessagesSwellMessage extends com.google.api.client.json.GenericJson {
   ...
   */
  public ModelForecastMessagesSwellMessage setCompassDirection(java.lang.String compassDirection) {
   ...
   */
  public ModelForecastMessagesSwellMessage setDirection(java.lang.Double direction) {
   ...
   */
  public ModelForecastMessagesSwellMessage setPeriod(java.lang.Double period) {
    this.period = period;
    return this;
  }
   ...
   */
  public ModelForecastMessagesSwellMessage setUnit(ModelForecastMessagesUnitLabelMessage unit) {
    this.unit = unit;
    return this;
  }
   ...
   */
  public ModelForecastMessagesSwellMessage setWaveHeight(java.lang.Double waveHeight) {
    this.waveHeight = waveHeight;
    return this;
  }

  @Override
  public ModelForecastMessagesSwellMessage set(String fieldName, Object value) {
    return (ModelForecastMessagesSwellMessage) super.set(fieldName, value);
  }

  @Override
  public ModelForecastMessagesSwellMessage clone() {
    return (ModelForecastMessagesSwellMessage) super.clone();
  }
